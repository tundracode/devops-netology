...
```shell
~/DEVSYS/devops-netology/07-terraform-03-basic/terraform$ terraform workspace list
  default
* prod
  stage
```
...
```bash
 ~/DEVSYS/devops-netology/07-terraform-03-basic/terraform$ terraform plan 
...
![](img/Screenshot%202022-09-09%20at%2017.39.56.png)

![](img/Screenshot%202022-09-09%20at%2017.40.18.png)
